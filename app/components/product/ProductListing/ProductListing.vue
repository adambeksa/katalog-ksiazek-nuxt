...
import ProductListingSkeleton from './ProductListingSkeleton.vue';
...
<style scoped>
  /* Styles are imported in the skeleton since they share them, or we can move them here if needed */
  /* In Next.js they were often in the same folder */
